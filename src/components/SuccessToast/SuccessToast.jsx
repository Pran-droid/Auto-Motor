...
export default function SuccessToast({ show, onClose, message, subText }) {
  // 'visible' controls whether the DOM element exists
  ...
  return (
    <div className={`toast-container ${animating ? 'toast-exit' : ''}`}>
      <div className="card">
        ...
        <div className="message-text-container">
          <p className="message-text">{message || 'Update Saved'}</p>
          <p className="sub-text">{subText || 'Hardware sync successful'}</p>
        </div>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 15 15"
